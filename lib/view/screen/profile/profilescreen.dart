                              ...
                              return Stack(
                                children: [
                                  Padding(
                                    ...
                                    child: CircleAvatar(
                                      radius: Get.size.width / 6,
                                      backgroundImage: controllerpro.image !=
                                              null
          ...
          GetBuilder<ProfileControllerImp>(
            builder: (controller) => Container(
              ...
              child: ListView.builder(
                  ...
                  // shrinkWrap: true,
                  itemCount: controller.enrolled.length,
                      ...
                      return InkWell(
                        onTap: () async {
                          await videosControllerImp
                              .getCourseDetails(controller.enrolled[index].id!);
                          Get.to(CourseDetailsPage());
                        },
                        child: Padding(
                          padding: const EdgeInsets.only(
                              right: 20.0, left: 20, bottom: 10, top: 5),
                          child: Container(
                            width: 310,
                            height: 190,
